...
To attach the debugger from the command line, use:
    ...
    */
    ...
    {
        private static string msbuildFileFullPath = @"""D:\Program Files (x86)\Microsoft Visual Studio 11.0\Common7\IDE\devenv.exe""";
        private static readonly string vsDevenvFileFullPath = @"""D:\Program Files (x86)\Microsoft Visual Studio 11.0\Common7\IDE\devenv.exe""";
        ...
        private static string BuildSolutionCommand = " {0} /Build";
        private static string EditFileCommand = " /Edit {0} ";
